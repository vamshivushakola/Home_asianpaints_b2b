 ...
 *
 */
package com.asianpaintsb2b.core.hmc;
...
/**
 * Provides necessary meta information about the asianpaintsb2bcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class Asianpaintsb2bCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(Asianpaintsb2bCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.asianpaintsb2b.core.hmc.locales";
