...
/**
 * Generated class for type {@link com.asianpaintsb2b.core.jalo.Asianpaintsb2bSizeVariantProduct Asianpaintsb2bSizeVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedAsianpaintsb2bSizeVariantProduct extends Asianpaintsb2bStyleVariantProduct
{
	/** Qualifier of the <code>Asianpaintsb2bSizeVariantProduct.size</code> attribute **/
	public static final String SIZE = "size";
	protected static final Map<String, AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;
	static
	{
		final Map<String, AttributeMode> tmp = new HashMap<String, AttributeMode>(Asianpaintsb2bStyleVariantProduct.DEFAULT_INITIAL_ATTRIBUTES);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Asianpaintsb2bSizeVariantProduct.size</code> attribute.
	...
	public String getSize(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedAsianpaintsb2bSizeVariantProduct.getSize requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>Asianpaintsb2bSizeVariantProduct.size</code> attribute. 
	...
	public void setSize(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAsianpaintsb2bSizeVariantProduct.setSize requires a session language", 0 );
		}
