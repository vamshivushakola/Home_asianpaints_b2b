			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("asianpaintsb2bcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("asianpaintsb2bcockpits.product.externalTaxes"));
