 ...
 *
 */
package com.asianpaintsb2b.cockpits.setup;
...
import com.asianpaintsb2b.cockpits.constants.Asianpaintsb2bCockpitsConstants;
 ...
 */
@SystemSetup(extension = Asianpaintsb2bCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Asianpaintsb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Asianpaintsb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Asianpaintsb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/asianpaintsb2bcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
