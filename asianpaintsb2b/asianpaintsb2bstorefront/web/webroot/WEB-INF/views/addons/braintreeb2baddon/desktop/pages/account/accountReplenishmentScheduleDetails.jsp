...
<%@ taglib prefix="b2b-order-paypal" tagdir="/WEB-INF/tags/addons/braintreeb2baddon/desktop/order" %>
...
<div class="column accountContentPane clearfix orderList replenishment-detail">
	...
	<div class="span-19 delivery_stages">
		...
		<div class="span-7">
			<b2b-order-paypal:paymentMethodItem order="${scheduleData}" brainTreePaymentInfo="${brainTreePaymentInfoData}"/>
		</div>
