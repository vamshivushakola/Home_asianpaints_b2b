...
import com.asianpaintsb2b.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/asianpaintsb2bfulfilmentprocess/test/asianpaintsb2bfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/asianpaintsb2bfulfilmentprocess/test/asianpaintsb2bfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/asianpaintsb2bfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/asianpaintsb2bfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/asianpaintsb2bfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/asianpaintsb2bfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/asianpaintsb2bfulfilmentprocess/test/asianpaintsb2bfulfilmentprocess-spring-testcleanup.xml"));
