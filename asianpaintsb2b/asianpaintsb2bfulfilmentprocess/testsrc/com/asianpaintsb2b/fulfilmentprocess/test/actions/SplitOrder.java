 ...
 *
 */
package com.asianpaintsb2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(Asianpaintsb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Asianpaintsb2bFulfilmentProcessConstants.PARENT_PROCESS);
