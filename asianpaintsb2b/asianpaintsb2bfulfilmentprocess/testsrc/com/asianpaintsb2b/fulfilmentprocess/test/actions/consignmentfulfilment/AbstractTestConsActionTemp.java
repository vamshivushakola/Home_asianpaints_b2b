 ...
 *
 */
package com.asianpaintsb2b.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, Asianpaintsb2bFulfilmentProcessConstants.PARENT_PROCESS);
