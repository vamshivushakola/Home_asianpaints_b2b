 ...
 *
 */
package com.asianpaintsb2b.test.setup;
...
import com.asianpaintsb2b.test.constants.Asianpaintsb2bTestConstants;
import com.asianpaintsb2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Asianpaintsb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/asianpaintsb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/asianpaintsb2btest/import/reviews.impex");
			...
			importImpexFile(context, "/asianpaintsb2btest/import/cstickets.impex");
		}
	}
}
