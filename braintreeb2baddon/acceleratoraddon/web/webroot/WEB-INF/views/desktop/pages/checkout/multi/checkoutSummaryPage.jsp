...
<%@ taglib prefix="b2b-multi-checkout-paypal" tagdir="/WEB-INF/tags/addons/braintreeb2baddon/desktop/checkout/multi" %>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div id="placeOrder" class="span-14 append-1">
		<b2b-multi-checkout-paypal:summaryFlow deliveryAddress="${cartData.deliveryAddress}" deliveryMode="${deliveryMode}" paymentInfo="${paymentInfo}" requestSecurityCode="${requestSecurityCode}" cartData="${cartData}" brainTreePaymentInfo="${brainTreePaymentInfoData}"/>
