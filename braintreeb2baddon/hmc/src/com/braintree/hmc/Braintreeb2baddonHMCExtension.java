...
/**
 * Provides necessary meta information about the braintreeb2baddon hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.0-SNAPSHOT
 */
public class Braintreeb2baddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(Braintreeb2baddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.braintree.hmc.locales";
