package de.hybris.platform.omsb2b.integration;
...
import de.hybris.platform.omsb2b.actions.order.SourceOrderAction;
...
public class CancellationIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void setup() throws IOException, ImpExException
	{
		...
		importCsv("/omsb2b/test/impex/integration-test-data-default.impex", WarehousingTestConstants.ENCODING);
		importCsv("/omsb2b/test/impex/integration-test-data-simple.impex", WarehousingTestConstants.ENCODING);
	...
	public void cancelConsignmentEntrySuccess()
	{
		...
		final OrderProcessModel process = getBusinessProcessService().<OrderProcessModel> createProcess(
				order.getCode() + "_ordermanagement", Omsb2bConstants.ORDER_PROCESS_NAME);
