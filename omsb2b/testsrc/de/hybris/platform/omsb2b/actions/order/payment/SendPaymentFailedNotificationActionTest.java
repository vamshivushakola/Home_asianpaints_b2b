 ...
 *
 */
package de.hybris.platform.omsb2b.actions.order.payment;
...
import de.hybris.platform.omsb2b.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.omsb2b.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
