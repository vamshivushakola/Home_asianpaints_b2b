...
/**
 * This is the extension manager of the Braintree extension.
 */
public class BraintreeManager extends GeneratedBraintreeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BraintreeManager.class.getName());
	...
	{
		return (BraintreeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BraintreeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BraintreeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BraintreeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BraintreeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BraintreeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
